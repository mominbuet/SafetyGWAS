...
/*
long double divFact(int a, int b){
	
	return ((exp(lgamma(a)-lgamma(b)) * (long double)(a)))/(long double)(b) ;
}
*/
...
//int main()
//{
  //long double var = divFact(100, 99);
  //printf("%lf \n", var) ;
  //printf("%lf\n", (100.0/99.0) * exp(lgamma(100)-lgamma(99)) );
  
  //long double temp1 = divFact(11,3);
  //long double temp2 = divFact(8,6);
  //long double temp3 = divFact(9,8);
  //long double temp4 = divFact(10,2);
  //long double temp5 = divFact(1,19);
  //long double temp6 = divFact(1,30);
  
  
  //double temp7 = divFact(200,100);
  //double temp8 = divFact(1,100);
  
  //long double lob = temp1 * temp2 * temp3 * temp4 * temp5;
  //long double hor = temp7 * temp8;
  
  //long double p_value = lob/hor;
  
  
  
  //printf("%Lf \n", lob) ;
  
  //double p_val = fisher23(0, 3, 2, 6, 5, 1, 0);
  //double p_val = fisher23(70, 20, 10, 40, 30, 30, 0);
